...
var app = (function () {
    ...
    /* src/Layout.svelte generated by Svelte v3.44.1 */
    ...
    var routes = Route.define([
        Route.group('', {layout: Layout}, [
            Route.path('/', {view: Main, title: 'Биржа заявок'}),
        ])
    ]);

    /* src/Router/Router.svelte generated by Svelte v3.44.1 */
    ...
    function create_key_block(ctx) {
    	...
    	dispatch_dev("SvelteRegisterBlock", {
    		...
    		type: "key",
    		source: "(156:8) {#key changeTrigger}",
    		ctx
    	});
    ...
    // (155:4) <svelte:component this={layout}>
    function create_default_slot(ctx) {
    	...
    	dispatch_dev("SvelteRegisterBlock", {
    		...
    		type: "slot",
    		source: "(155:4) <svelte:component this={layout}>",
    		ctx
    	});
    ...
    function create_fragment(ctx) {
    	...
    	const block = {
    		c: function create() {
    			...
    			attr_dev(div, "class", "container-fluid px-0 root night");
    			add_location(div, file, 3, 0, 74);
    		},
    		l: function claim(nodes) {
    			throw new Error("options.hydrate only works if the component was compiled with the `hydratable: true` option");
    		},
